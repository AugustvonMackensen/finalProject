...
public class NaverLoginAuth {
	...
	private final static String CLIENT_ID = "X68SERauT9CWpVmJ06ux";
	private final static String CLIENT_SECRET = "LCToOcVGRK";
	private final static String REDIRECT_URI = "http://localhost:8080/gammi/ncallback.do";
