  ...
  => 로그인한 회원이 관리자이면 공지글 등록 버튼이 보이게 함 -->
		...
		<section class="notice">
			...
			<div id="board-search">
				<div class="container">
					<div
						style="max-height: 30px; font-family: 'Noto Sans KR', sans-serif; font-size: 14px">
			...
			<div id="board-list">
				<div class="container">
						...
						<c:forEach items="${ requestScope.list }" var="b">
							<tbody>
								<tr>
									...
									<td>${ b.b_readcount }</td>
									<td>${ b.b_writer }</td>
									<td><c:if test="${ !empty b.b_original_image }">◎</c:if> <c:if
											test="${ empty b.b_original_image }">&nbsp;</c:if></td>
					...
					<c:if test="${ !empty sessionScope.loginMember and sessionScope.loginMember.admin ne 'Y' }">
						<button class="rightbtn" onclick="javascript:location.href='bwform.do';">게시글 등록</button>
					</c:if>
